import { Box, Container, Divider, Link, List, ListItem, ListItemAvatar, ListItemText, Pagination, Typography } from '@mui/material';
                ...
                works.map((work, index) => {
                    return (
                        <Link underline='none'>
                            <ListItem>
                                <ListItemAvatar>
                                    <WorkHistoryTwoToneIcon sx={{color: "primary.dark", fontSize: "3rem"}}/>
                                </ListItemAvatar>
                                <ListItemText
                                    primary={work.name}
                                    secondary={
